...
export const COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    steps: [
      "Read `AI-OFFICE.md`, `.ai-office/project.config.md`, `.ai-office/office-profile.md`, and `.ai-office/pipeline.md` when present.",
  ...
  },
  {
    ...
    steps: [
      "Read `AI-OFFICE.md`, `.ai-office/project.config.md`, `.ai-office/office-profile.md`, and `.ai-office/pipeline.md` if they exist.",
      ...
      "Identify the likely next artifact or generated pipeline stage, including whether a PRD, ADR, plan, or direct task work is appropriate.",
